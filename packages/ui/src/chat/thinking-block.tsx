...
import { useAgentActivity, type ThinkingStep } from "./agent-activity-context";
...
export function ThinkingBlock({ avatar, appName }: ThinkingBlockProps) {
  ...
  if (visibleSteps.length === 0 && isStreaming) {
    return (
      <div
        ...
        role="status"
        aria-label={`${appName} is thinking...`}
      >
