/**
 * T2-03: Trust signals bar — below hero, above social proof.
 * Reduces friction with security/UX trust signals.
 */
const TRUST_SIGNALS = [
  {
    ...
    <section className="border-b border-border/40 py-4">
      <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-center gap-x-8 gap-y-2 px-6">
        {TRUST_SIGNALS.map((signal) => (
          ...
          >
            <span className="text-muted-foreground/50">{signal.icon}</span>
            {signal.label}
          </div>
        ))}
      </div>
